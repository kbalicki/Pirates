...
export const EN: LocaleData = {
  ...
  "help.world_lanes_b": "Every town has a named supplier for what it does not grow, and the traders really sail that route, going round the land. Press T to draw the lanes. A merchantman carries whatever her lane carries: what you take goes into your hold, as much of it as will fit.",
  ...
  "help.world_defense_b": "The governor of a crown that counts you its own - a letter of marque, or standing at \"ally\" - will pay to hold a threatened colony. Be there before the landing. The deadline is in the Journal (SPACE).",
  ...
  "help.econ_prices_b2": "Every port makes its own exports (2-12 units a day by market level) and eats its imports (scaled to population). The warehouse holds market level x 50.",
  "help.econ_wealth_h": "WEALTH AND DEFENCE",
  "help.econ_wealth_b": "Selling goods that are wanted raises wealth. A shortfall of imports costs it 1 a day.\nDefence falls after a raid. Weak defence is an easier town to plunder.",
  "help.econ_war_h": "WAR AT SEA",
  "help.econ_war_b1": "An active war -> the crowns at war put twice as many ships to sea, and the share of men-of-war among them rises from 45% to 70%.",
  "help.econ_war_b2": "The historical wars have fixed dates (1689-1697, the Nine Years' War: France against England, the Dutch and Spain). The list is in the taverns and with the NPCs you meet.",
