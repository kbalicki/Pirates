...
export const EN: LocaleData = {
  ...
  "informer.offer": "Informer: cut the {{from}}–{{port}} run — {{gold}} gold, {{days}} days",
  "informer.in_hand": "Commission: {{from}}–{{port}} — {{done}}% cut, {{days}} days left",
  "informer.taken": "The informer nods. The {{from}}–{{port}} run, then — and {{crown}} will know whose work it was.",
