...
export const EN: LocaleData = {
  ...
  "governor.pardon_offer": "My predecessor's quarrels came with the house, captain, and I have not read them all. {{faction}} has {{points}} points against you, and not one of them is mine. {{gold}} gold towards the fitting of this residence, and what you did before today did not happen in this harbour. Outside it I answer for nothing.",
  ...
  "tavern.divide_plunder": "Divide the plunder — {{leave}} will go ashore ({{days}} days)",
  "tavern.divide_plunder_overdue": "Divide the plunder — {{leave}} go ashore. {{days}} days overdue!",
  ...
  "tavern.divide_confirm_body": "You have {{crew}} hands aboard. The chest goes on the table: {{pay}} gold to the crew, {{kept}} stays with you.",
  "tavern.divide_confirm_warning": "WARNING: two thirds of the crew go ashore with the money. {{leaving}} men will leave — the ones you have just signed on among them.",
  ...
  "tavern.rumor_hurricane_bound": "\"There's a hurricane over {{port}}, standing on for {{bound}} \u2014 {{days}} days of it left. Keep the whole of it on your beam or stay alongside.\"",
  "tavern.rumor_hurricane": "\"There's a hurricane sitting over {{port}} and it is not done yet \u2014 {{days}} days of it, they reckon. Nobody with a choice is at sea this week.\"",
  ...
  "village.trade": "Barter {{rum}} tons of rum for {{gold}} of gold",
  "village.trade_cooldown": "Nothing to barter — come back in {{days}} days",
  "village.trade_done": "{{gold}} tons of gold aboard. They will remember it.",
  "village.trade_no_rum": "They want rum. You have none to spare.",
  "village.war_party": "Ask them to fall on {{port}} ({{rum}} tons of rum)",
  "village.war_party_locked": "A war party — they do not trust you that far ({{standing}}/{{needed}})",
  "village.war_party_no_rum": "A war party — they want {{rum}} tons of rum first",
  ...
  "village.log_trade": "Bartered {{rum}} tons of rum at {{village}} for {{gold}} of gold.",
