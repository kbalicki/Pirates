...
export const PL: LocaleData = {
  ...
  "help.econ_prices_b2": "Każdy port produkuje swoje towary eksportowe (×2–12 j./dzień zależnie od marketLevel) i konsumuje importowe (skala z populacją). Magazyn ma limit marketLevel × 50.",
