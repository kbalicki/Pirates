...
export const PL: LocaleData = {
  ...
  "help.world_lanes_b": "Każde miasto ma nazwanego dostawcę tego, czego samo nie produkuje — kupcy płyną tą trasą naprawdę, omijając ląd. Klawisz T rysuje szlaki na mapie. Statek handlowy wiezie to, co niesie jego szlak: zdobyty ładunek trafia do twojej ładowni, ile się zmieści.",
  ...
  "help.world_defense_b": "Gubernator korony, która liczy cię za swojego (list kaperski albo standing „sojusznik”), zapłaci za utrzymanie zagrożonej kolonii. Dotrzyj tam przed desantem. Termin jest w Dzienniku (SPACE).",
  ...
  "help.econ_wealth_b": "Sprzedaż towarów z popytem podnosi bogactwo. Niedobór importu obniża je o 1/dzień.\nObrona spada po napadach piratów/Indian. Słaba obrona = łatwiejszy port do rabunku.",
  "help.econ_war_h": "WOJNA NA MORZU",
  "help.econ_war_b1": "Aktywna wojna → walczące korony wypuszczają ×2 więcej statków, a udział okrętów wojennych rośnie z 45% do 70%.",
  "help.econ_war_b2": "Historyczne wojny mają stałe daty (np. 1689–1697 Wojna 9-letnia: Francja vs Anglia + Niderlandy + Hiszpania). Lista wojen w karczmie i u napotkanych NPC.",
