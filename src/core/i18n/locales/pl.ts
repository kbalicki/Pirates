...
export const PL: LocaleData = {
  ...
  "help.sail_levels_b": "W/S zmienia: Zwinięte → Zrefowane → Połowa → Pełne. Zmiana trwa 2s przy pełnej obsadzie — przy szczątkowej nawet trzy razy dłużej.",
  ...
  "help.econ_war_b1": "Aktywna wojna → walczące frakcje wypuszczają ×2 więcej statków, a udział okrętów wojennych rośnie z 45% do 70%.",
