...
export const PL: LocaleData = {
  ...
  "help.world_reputation_b": "Każda frakcja pamięta twoje czyny. Wrogość = trudniejszy dostęp do portów.",
  ...
  "help.event_governor_fx": "+50 bogactwa, możliwy reset reputacji",
