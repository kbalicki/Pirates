...
export const PL: LocaleData = {
  ...
  "governor.letter_available_switch": "Gubernator oferuje ci List Kaperski — ale nosisz list {{other}}, a żadna korona nie dzieli się korsarzem. Podpisz tutaj, a tamten papier przepada.",
  "privateer.log_prize": "{{faction}} uznaje pryz za dobry.",
  "privateer.log_uncovered": "{{faction}} nie ma zatargu z {{victim}}. Twój list jest dla niej wstydem.",
  "privateer.log_revoked": "{{faction}} podarła twój List Kaperski.",
  "privateer.log_given_up": "Oddałeś List Kaperski od {{faction}}.",
  ...
  "weather.hurricane_toast_bound": "Huragan pod {{port}}, idzie na {{bound}}! Wiatr krąży wokół oka \u2014 trzymaj je na trawersie i wychodź z niego.",
  "weather.log_hurricane_bound": "Złapani przez huragan pod {{port}}, idzie na {{bound}}.",
  "weather.chart_storm": "Huragan — {{days}} dni",
  "weather.chart_storm_bound": "Huragan, idzie na {{port}} — {{days}} dni",
  ...
  "plate.course_label": "flota skarbów, na {{port}} — {{days}} dni",
  "plate.log_sighted": "Namierzona flota skarbów pod {{port}}.",
  ...
  "news.pardon_granted": "Nowy gubernator {{port}} odk\u0142ada twoj\u0105 kart\u0119 u {{faction}}.",
  ...
  "port.standing_via_pardon": "u\u0142askawiony tutaj — nowy gubernator od\u0142o\u017cy\u0142 kart\u0119 {{crown}}",
  ...
  "village.war_party": "Poproś o wyprawę na {{port}} ({{rum}} ton rumu)",
  ...
  "village.log_war_party": "{{village}} chwyta za broń przeciw {{port}}.",
};
