...
export const PL: LocaleData = {
  ...
  "informer.offer": "Informator: przetnij szlak {{from}}–{{port}} — {{gold}} zł, {{days}} dni",
  "informer.in_hand": "Zlecenie: {{from}}–{{port}} — przecięte w {{done}}%, zostało {{days}} dni",
  "informer.taken": "Informator kiwa głową. A więc szlak {{from}}–{{port}} — i {{crown}} będzie wiedziała, czyja to robota.",
