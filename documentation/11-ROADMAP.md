...
- **Pogoda rozszerzona** — ✅ szkwał (v0.38.0) i ✅ huragany sezonowe jako prawdziwy sztorm na wodzie, z krążącym wiatrem i strefami wiatru mapy (v0.39.0). ✅ mgła (v0.40.0 — tnie zasięg graczowi **i** NPC, bez darcia płótna). Zostały: prądy morskie, deszcz i pioruny, oraz **wędrujące oko** huraganu
