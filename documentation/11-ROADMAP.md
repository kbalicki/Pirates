...
- ✅ **Ułaskawienie u nowego gubernatora** (v0.61.0) — ekran pomocy obiecywał *„+50 bogactwa, możliwy reset reputacji”* od **v0.9.7.1**, pięćdziesiąt jeden wydań, a zdarzenie dopisywało miastu wyłącznie pięćdziesiąt złotych. Nie była to ozdoba: standing poniżej `neutral` zamyka list kaperski, zlecenie obrony, córkę gubernatora i kantor frachtowy, więc jedyną drogą w górę był spichlerz za **+8** w głodującym mieście. Pomiar (20 ziaren × 50 lat: **7975** nominacji, 6% wszystkich zdarzeń, ok. 8 rocznie, mediana odstępu u Hiszpanii **65 dni**) zabił dosłowne czytanie — amnestia całej korony co dwa miesiące to wyłącznik reputacji. Wydane jako `PardonSystem`: **lokalne**, kupowane w ciągu 30 dni od nominacji, podnosi **do `neutral` i nie wyżej**, obejmuje kartotekę z dnia podpisu i pada, gdy kapitan da nowy powód. Pole opcjonalne na mieście — migracje dalej v12
