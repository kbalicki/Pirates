...
**Stan na:** 2026-09-11 · **Wersja:** v0.59.0.0 · **Branch:** `main`
**Kod:** 228 plików `.ts` · `tsc --noEmit` czysty · `npm test` — **1967 przechodzi, 0 failuje, 0 `todo`** w 55 plikach
