...
**Stan na:** 2026-09-06 · **Wersja:** v0.45.0.0 · **Branch:** `main`
**Kod:** 207 plików `.ts` · `tsc --noEmit` czysty · `npm test` — **1638 przechodzi, 0 failuje, 0 `todo`** w 46 plikach
